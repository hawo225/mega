		...
		<div class="inner-wrap">
			...
			<div class="lnb-area addchat location-fixed">
				...
				<ul>
					...
					<li class="on"><a href="http://localhost:80/movie/boardlist" title="게시판">게시판</a></li>
...
<div class="btn-group right">
						<a href="http://localhost:80/movie/created" class="button purple" id="myQnaBtn" title="게시글 작성">게시글 작성</a><!-- btn-layer-open -->
					</div>
				...
				<div class="tab-block mb30">
					...
					<!-- on tabBtn으로 설정하면 가장 먼저 보이는 버튼 속성 -->
						...
						<li class="tabBtn"><button type="button" class="btn"
								data-no="81" title="자유게시판 보기">자유 게시판</button></li>

						<li class="tabBtn"><button type="button" class="btn"
								data-no="82" title="지점 공지 보기">후기 게시판</button></li>
