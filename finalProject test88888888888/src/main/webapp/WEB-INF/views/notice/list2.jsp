	...
	<div class="container has-lnb">
		<div class="page-util">
			<div class="inner-wrap" id="myLoaction">
				<div class="location">
					<span>Home</span> <a href="https://www.megabox.co.kr/mypage"
						title="나의 메가박스 페이지로 이동">나의 메가박스</a> <a
						href="https://www.megabox.co.kr/mypage/myinquiry"
						title="나의 문의내역 페이지로 이동">나의 문의내역</a> <a
						href="http://localhost:8080/movie/created"
						title="1:1 문의내역 페이지로 이동">1:1 문의내역</a>
				</div>
			</div>
		</div>
...
$(function(){
	...
	$.get('/on/oh/ohh/MyScnBoard/selectCponMbNoCount.do')
			...
			<div class="lnb-area">
				<nav id="lnb">
				<p class="tit">
					<a href="https://www.megabox.co.kr/mypage" title="나의 메가박스">나의
						메가박스</a>
				</p>

				<ul>
					<li class=""><a
						href="https://www.megabox.co.kr/mypage/bookinglist"
						title="예매/구매내역">예매/구매내역</a></li>
					<li><a href="https://www.megabox.co.kr/mypage/movie-coupon"
						title="영화/스토어 관람권">영화/스토어 관람권</a>
						<ul class="depth3">
							<li><a href="https://www.megabox.co.kr/mypage/movie-coupon"
								title="영화관람권">영화관람권</a></li>
							<li><a href="https://www.megabox.co.kr/mypage/store-coupon"
								title="스토어 교환권">스토어 교환권</a></li>
						</ul></li>
					<li><a id="discountCoupon"
						href="https://www.megabox.co.kr/mypage/discount-coupon"
						title="메가박스/제휴쿠폰">메가박스/제휴쿠폰</a></li>
					<!-- <li><a href="/on/oh/ohh/Mvtckt/GiftCardL.do">메가박스 기프트카드</a></li> -->
					<li><a href="https://www.megabox.co.kr/mypage/point-list"
						title="멤버십 포인트">멤버십 포인트</a>
						<ul class="depth3">
							<li><a href="https://www.megabox.co.kr/mypage/point-list"
								title="포인트 이용내역">포인트 이용내역</a></li>
							<li><a href="https://www.megabox.co.kr/mypage/card-list"
								title="멤버십 카드관리">멤버십 카드관리</a></li>
							<li><a href="https://www.megabox.co.kr/mypage/milk-service"
								title="MiL.k 제휴서비스">MiL.k 포인트</a></li>
						</ul></li>
					<li><a href="https://www.megabox.co.kr/mypage/moviestory"
						titel="나의 무비스토리">나의 무비스토리</a></li>
					<li><a href="https://www.megabox.co.kr/mypage/myevent"
						title="나의 이벤트 응모내역">나의 이벤트 응모내역</a></li>
					<li class="on"><a
						href="https://www.megabox.co.kr/mypage/myinquiry" title="나의 문의내역">나의
							문의내역</a></li>
					<li><a href="https://www.megabox.co.kr/mypage/mydiscount"
						title="자주쓰는 할인 카드">자주쓰는 카드 관리</a></li>
					<li><a
						href="https://www.megabox.co.kr/mypage/myinfo?returnURL=info"
						title="회원정보">회원정보</a>
						<ul class="depth3">
							<li><a
								href="https://www.megabox.co.kr/mypage/myinfo?returnURL=info"
							...
							<li><a
								href="https://www.megabox.co.kr/mypage/additionalinfo"
								title="선택정보 수정">선택정보 수정</a></li>
						</ul></li>
				</ul>
				</nav>
			</div>
			...
			<div id="contents" class="">
				...
				<div class="tab-block">
					<ul>
						<li data-url="/mypage/myinquiry?cd=INQD01" class="on"><a
							href="https://www.megabox.co.kr/mypage/myinquiry#" class="btn"
							data-cd="INQD01" title="1:1 문의내역 탭으로 이동">1:1 문의내역</a></li>
				...
				<div class="mypage-infomation mt20">
					...
					<div class="btn-group right">
						<a href="http://localhost:8080/movie/created" class="button"
							id="inqBtn" title="1:1 문의하기">1:1 문의하기</a>
					</div>
				</div>
				...
				<div class="board-list-util mb10">
					...
					<div class="table-wrap">
						<table class="board-list a-c">
							<caption>번호, 극장, 유형, 제목, 답변상태, 등록일 순서로 보여주는 1:1 문의 내역
								표입니다</caption>
							<colgroup>
