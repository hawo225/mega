		...
		<div class="inner-wrap">
			<div class="lnb-area addchat">
				<nav id="lnb">
					...
					<ul>
						...
						<li><a href="http://localhost:80/movie/created" title="공지사항">공지사항</a></li>
			...
			<div id="contents" class="">
				...
				<div class="btn-group pt40">
					<a href="javascript:location.href='<%=cp%>/movie/updated2?num=${dto.num }&${params }';" class="button large listBtn" title="수정">수정</a>
					<a href="javascript:location.href='<%=cp%>/movie/deleted2_ok?num=${dto.num }&${params }';" class="button large listBtn" title="삭제">삭제</a>
					<a href="javascript:location.href='<%=cp%>/movie/list2?${params }';" class="button large listBtn" title="리스트">리스트</a>
				</div>
			</div>
		</div>
	</div>
